...
?>
  <tr><td  >
            ...
            <table cellpadding="0" cellspacing="30" width="700px" height="150px" style="margin:auto; border:none;" class="tableborder">


                <tr><td width="100px"  align="center" style="vertical-align:middle">

 <a href="doner_pic<?php echo $data[8] ?>"data-lightbox="image-1"> <img src="doner_pic/<?php echo $data[8] ?>" height="100px" width="100px" style="margin:auto; padding-left:90px; padding-right:50px; float:left" /></a></td>

&nbsp;&nbsp;&nbsp;
                    <td width="500px" height="50px" style="vertical-align:top">
                        

                        <table cellpadding="60" width="500px" height="150px" style="border:none" float="right">
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved | Design by Md.Shahedul Islam |</p>
		</div>
	<div class="clear"></div>
</div>
</div>
